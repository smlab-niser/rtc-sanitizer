//                                    VERSION 5. 
// THIS VERSION IS A SIMPLIFIED APPLICATION. YOU DONT NEED POTENTIOMETER TO ADJUST ACTIVATION TIME. 
//ACTIVATION TIME IS FIXED AND TO MAKE AN OPERATIONAL UNIT, YOU ONLY NEED A PUMP, A RELAY, AND AND ULTRASONIC SENSOR IN ADDITION TO THE POWER SUPPLY AND AN ARDUINO NANO


//                                    VERSION 4.
// THIS VERSION USES AN ULTRASONIC SENSOR INSTEAD OF AN IR PROXIMITY SENSOR
...
long timer = 500; // ***********We are making the activation time fixed, unchangable from potentiometer.
...
//STEP 1: Loop initialisation
 ...
 // timer= map(potval, 0, 1023, 0, maxtime);    ***************DISABLING TIMER CONTROL FROM POTENTIOMETER.**********
